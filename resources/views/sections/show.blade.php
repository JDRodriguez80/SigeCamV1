            ...
            <div class="col-md-8 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Sección: {{ $section->name }}</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8 form-group">
                                <p>{{ $section->created_at->format('d/m/Y H:i') }}</p>
                            </div>
                        </div>
                        <div class="mt-3">
                            <a href="{{ route('sections.index') }}" class="btn btn-secondary">Volver al Listado</a>
