    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ request()->routeIs('sections.*') ? 'active' : '' }}">
                    <a href="{{ route('sections.index') }}" class='sidebar-link'>
                        <i class="bi bi-person-workspace"></i>
                        <span>Secciones</span>
                    </a>
                </li>
                <li class="sidebar-item {{ request()->routeIs('academicCycles.*') ? 'active' : '' }}">
                    <a href="{{ route('academicCycles.index') }}" class='sidebar-link'>
                        <i class="bi bi-calendar2-month-fill"></i>
                        <span>Ciclos Escolares</span>
                    </a>
                </li>
                <li class="sidebar-item {{ request()->routeIs('gradeLevels.*') ? 'active' : '' }}">
                    <a href="{{ route('gradeLevels.index') }}" class='sidebar-link'>
                ...
                <li class="sidebar-item {{ request()->routeIs('enrollments.*') ? 'active' : '' }}">
                    <a href="{{ route('enrollments.index') }}" class='sidebar-link'>
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item">
                            <a href="{{ route('documentTypes.index') }}" class="submenu-link">Tipo de documentos</a>
                        </li>
                    </ul>
                </li>
