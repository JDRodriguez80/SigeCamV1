...
<head>
    ...
    <title>@yield('title', 'SIGE - Sistema de Gestión Estudiantil')</title>

    @if(isset($systemLogo) && $systemLogo)
        <link rel="shortcut icon" href="{{ asset('storage/' . $systemLogo) }}" type="image/x-icon">
    @else
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ms-auto mb-lg-0">
                                {{-- Puedes agregar elementos a la derecha de la barra de navegación aquí --}}
                            </ul>
                            <div class="dropdown">
